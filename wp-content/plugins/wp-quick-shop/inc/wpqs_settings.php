...
global $wpqs_premium_link, $wpqs_data, $wpqs_pro, $wpdb, $wpqs_url;

$instructions = wpqs_settings('instructions');
$admin_url = get_admin_url();
$tab_index = isset($_GET['t']) ? $_GET['t'] : 0;
...
<?php endif; ?>
    ...
    <div class="wpqs_icon">
    	<a href="<?php echo $wpqs_premium_link; ?>" target="_blank" class="qs-premium" title="<?php echo __('Go Premium', 'wp-quick'); ?>'">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <textarea name="wpqs_settings[instructions]"><?php echo $instructions; ?></textarea>
                                ...
                                <ul class="mt-3">
                                    ...
                                    <li>
                                        <label for="wpqs_options_search">
                                            ...
                                            <?php echo __('Search box on products table', 'wp-docs'); ?> (<?php echo $wpqs_pro?__('Optional', 'wp-quick'):'<a href="'.$wpqs_premium_link.'" target="_blank" class="qs-premium" title="'.__('Go Premium', 'wp-quick').'">'.__('Premium', 'wp-quick').'</a>'; ?>) - <a href="https://www.youtube.com/embed/rRKYoalkyJc" class="qs-link" target="_blank"><?php echo __('Video Tutorial', 'wp-quick'); ?></a>
                                        </label>
                                    </li>
    ...
    <form class="nav-tab-content hide wpqs-sohortcode-form" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" enctype="multipart/form-data">
        ...
        <pre>[WP-QUICKSHOP]<br /><br />[WP-QUICKSHOP type="woocommerce"]<br /><br />[WP-QUICKSHOP type="wp-e-commerce"]</pre>
            ...
            <select id="wpqs_custom_field_type" name="wpqs_custom_field[type]">
                <?php if(!empty($wpqs_custom_field_types)){
                    foreach ($wpqs_custom_field_types as $field_type => $field_name){
                        ...
                        $selected = ($wpqs_custom_field['type'] == $field_type)?'selected':'';
...
<!--                                                <pre><code class="css">--><?php //echo $custom_style_text ?><!--</code></pre>-->
    ...
    <script type="text/javascript" language="javascript">
        ...
        jQuery(document).ready(function($) {
            ...
            $t = isset($_REQUEST['t']) ? $_REQUEST['t'] : 0;
            $t = isset($_POST['wpqs_tn']) ? $_POST['wpqs_tn'] : $t;
            $t = trim($t);
